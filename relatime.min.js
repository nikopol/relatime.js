...
b?d("month",b/2592E3):d("year",b/31536E3)},n=function(){var a,c,b=0,d=document.querySelectorAll(e+"."+k);for(console.log("[relatime] refreshing",d.length,"date");b<d.length;){a=d[b];if(c=a.getAttribute("datetime"))a.innerHTML=m(c);++b}},p=function(a){void 0!=a&&a!=f&&h[a]&&(f=a,setTimeout(n,9));return f};p(navigator.language);return{setup:function(a){a.tag&&(e=a.tag);a.classname&&(k=a.classname);a.locale&&p(a.locale);a.interval&&(l=1E3*a.interval,this.started()&&this.start());void 0!==a.autostart&&
